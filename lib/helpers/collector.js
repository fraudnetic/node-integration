...
class Collector {
    ...
    amount(amount) {
        this._data.amount = String(amount);
        return this;
    }
    currency(currency) {
    ...
    betID(betID) {
        this._data.betID = String(betID);
        return this;
    }
    ticketID(ticketID) {
        this._data.ticketID = String(ticketID);
        return this;
    }
    documentID(documentID) {
        this._data.documentID = String(documentID);
        return this;
    }
    phoneNumber(phoneNumber) {
        this._data.phoneNumber = String(phoneNumber);
        return this;
    }
    registration() {
